                        ...
                        <div class="col-md-7">
                            <form action="{{ route('message.store') }}" method="post" class="php-email-form">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            <div class="d-flex justify-content-center align-items-center bg-primary text-white">+993<input type="number" placeholder="@lang('app.number')" class="form-control @error('number') is-invalid @enderror" name="phone" id="phone" autocomplete="off" min="61000000" max="65999999" aria-describedby="numberHelp" required></div>
                                            @error('phone')
                                            <div class="alert alert-danger mt-1">{{ $message }}</div>
                                            @enderror
                                        </div>
